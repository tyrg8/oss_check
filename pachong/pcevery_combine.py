...
# # 读取JSON文件
# with open('report_data.json', 'r', encoding='utf-8') as f1, open('table_data.json', 'r', encoding='utf-8') as f2:
#     json1 = json.load(f1)
#     print(len(json1))
#     json2 = json.load(f2)
#     print(len(json2))
...
# 示例调用
merge_json_files('table_data.json', 'report_data.json', 'merged.json', 'link')
